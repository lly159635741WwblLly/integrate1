...
public class ShowResults_Sensor extends AppCompatActivity implements AdapterView.OnItemClickListener, SearchView.OnQueryTextListener{

    public ListView listView;
    public List<FileInfo_Results> list;
    ...
    public  void onCreate(Bundle savedInstanceState) {
        ...
        myPreferences = getSharedPreferences("direction", MODE_PRIVATE);
        PATH= myPreferences.getString("dir", "");
...
//        file.mkdirs();// 创建目录
    ...
    public void showProgressDialog() {
        pd = new ProgressDialog(ShowResults_Sensor.this);
